...
# ResNet50 modelini yükleyin (top katmanları olmadan)
base_model = ResNet50(weights='imagenet', include_top=False, input_shape=(224, 224, 3))

# Yeni bir model oluşturun ve ResNet50 ile birleştirin
model = Sequential()
...
pred = model.fit(training_set, validation_data=valid_set, epochs=1, batch_size=32)
